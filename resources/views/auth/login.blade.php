        ...
        <div class="card">
            <div class="card-body p-5">
                <div class="text-center d-lg-none">
                    <img src="svg/modulr.svg" class="mb-5" width="150" alt="Tiendita de figuras">
                </div>
                <h1>{{ __('Login') }}</h1>
                <p class="text-muted">Logeate a tu cuenta</p>
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input id="email" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ old('email') }}" placeholder="{{ __('Correo Electronico') }}" required autofocus>
        ...
        <div class="card text-white bg-primary py-5 d-md-down-none">
            <div class="card-body text-center">
                <div>
                    ...
                    <a class="btn btn-primary active mt-2" href="{{ route('register') }}">{{ __('Registrate ahora!') }}</a>
                </div>
            </div>
        </div>
    </div>
